...
PyObject* PythonQtConv::QVariantMapToPyObject(const QVariantMap& m) { return mapToPython<QVariantMap>(m); }

PyObject* PythonQtConv::QVariantHashToPyObject(const QVariantHash& m) { return mapToPython<QVariantHash>(m); }
...
bool PythonQtConv::ConvertPythonListToQListOfPointerType(PyObject* obj, QList<void*>* list, const PythonQtMethodInfo::ParameterInfo& info,
                                                         bool /*strict*/) {
  bool result = false;
...
bool PythonQtConv::convertToQListOfPythonQtObjectPtr(PyObject* obj, void* /* QList<PythonQtObjectPtr>* */ outList, int /*metaTypeId*/,
                                                     bool /*strict*/) {
  bool result = false;
...
bool PythonQtConv::convertToPythonQtSafeObjectPtr(PyObject* obj, void* /* PythonQtSafeObjectPtr* */ outPtr, int /*metaTypeId*/,
                                                  bool /*strict*/) {
  // just store the PyObject inside of the smart ptr
