...
static int PythonQtInstanceWrapper_nonzero(PythonQtInstanceWrapper* wrapper) {
  ...
  if (result) {
    ...
    if (opSlot._type == PythonQtMemberInfo::Slot) {
      PyObject* resultObj =
          PythonQtSlotFunction_CallImpl(wrapper->classInfo(), wrapper->_obj, opSlot._slot, nullptr, nullptr, wrapper->_wrappedPtr);
...
static int PythonQtInstanceWrapper_setitem(PyObject* self, PyObject* index, PyObject* value) {
  ...
  PythonQtMemberInfo opSlot = isSetItem ? wrapper->classInfo()->member("__setitem__") : wrapper->classInfo()->member("__delitem__");
...
static PyMethodDef PythonQtClassWrapper_methods[] = {
    {"className", (PyCFunction)PythonQtClassWrapper_classname, METH_NOARGS, "Return the classname of the object"},
    {"inherits", (PyCFunction)PythonQtClassWrapper_inherits, METH_VARARGS, "Returns if the class inherits or is of given type name"},
    {"help", (PyCFunction)PythonQtClassWrapper_help, METH_NOARGS, "Shows the help of available methods for this class"},
    {"delete", (PyCFunction)PythonQtClassWrapper_delete, METH_VARARGS, "Deletes the given C++ object"},
...
PyTypeObject PythonQtClassWrapper_Type = {
    PyVarObject_HEAD_INIT(nullptr, 0) "PythonQt.PythonQtClassWrapper", /*tp_name*/
