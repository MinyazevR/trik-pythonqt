...
QByteArray PythonQtSlotInfo::signature() const { return PythonQtUtils::signature(_meta); }
...
void PythonQtSlotInfo::setGlobalShouldAllowThreads(bool flag) { _globalShouldAllowThreads = flag; }

bool PythonQtSlotInfo::getGlobalShouldAllowThreads() { return _globalShouldAllowThreads; }
