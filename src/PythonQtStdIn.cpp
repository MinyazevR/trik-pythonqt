...
static PyMethodDef PythonQtStdInRedirect_methods[] = {
    ...
    {"isatty", (PyCFunction)PythonQtStdInRedirect_isatty, METH_NOARGS, "returns True if this is a tty-like device. False by default."},
...
PyTypeObject PythonQtStdInRedirectType = {
    PyVarObject_HEAD_INIT(nullptr, 0) "PythonQtStdInRedirect", /*tp_name*/
